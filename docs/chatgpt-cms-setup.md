...
ev-bangladesh-screening,Bangladesh Screening,Screening,past-makes-future,cinema,,,"A screening connected to Bangladesh, part of Memory Library's international exchange.",Screening connected to Bangladesh.,BOOKING REQUIRED,,,timed,,,TRUE
...
ev-we-shine-lates,We Shine Community,Special Event,we-shine,"main, cinema, exterior",,,"Boathouse 5 stays open into the evening as part of We Shine Community, with the exhibition continuing and the exterior projection running after dark.",Evening opening for We Shine Community.,FREE,,,timed,,,FALSE
```
